#!/bin/bash
# Full DataLoader benchmark sweep on A100 CPU nodes
#SBATCH --job-name=dl_full_bench
#SBATCH --partition=A100-80GB
#SBATCH --gres=gpu:0
#SBATCH --cpus-per-task=32
#SBATCH --mem=64G
#SBATCH --time=06:00:00
#SBATCH --output=/netscratch/%u/dl_full_bench.out
#SBATCH --error=/netscratch/%u/dl_full_bench.err
